...
{
    protected final static String MSG_API_KEY_REQUIRED = "Developer API key and API ID required";
    ...
    protected final static String MSG_INVALID_DEVELOPER_KEY = "Invalid developer api key/id";
