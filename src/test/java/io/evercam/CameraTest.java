...
public class CameraTest
{
    ...
    public void testPatchCamera() throws EvercamException
    {
        ...
        //FIXME: unknown_error while running on test server
